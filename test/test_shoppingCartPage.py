...
@pytest.mark.single2()
def test_ValdiateTheShoppingCartDetails(page,loginToAmazon,homePageObj,resultsPageObj):
...
def test_ValdiateTheShoppingCartDetails12(page,loginToAmazon,homePageObj):
    # homePageObj = homePage(page)
    homePageObj.enterProductToSearch("iphone")
    homePageObj.clickOnSearchBtn()
